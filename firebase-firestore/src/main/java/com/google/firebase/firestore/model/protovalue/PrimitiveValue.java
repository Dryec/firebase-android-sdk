...
public class PrimitiveValue extends FieldValue {
  ...
  public int typeOrder() {
    return ProtoUtil.typeOrder(internalValue);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof PrimitiveValue) {
      ...
      return ProtoUtil.equals(this.internalValue, value.internalValue);
    }
  ...
  public int compareTo(@NonNull FieldValue other) {
    if (other instanceof PrimitiveValue) {
      return ProtoUtil.compare(this.internalValue, ((PrimitiveValue) other).internalValue);
    } else if (ProtoUtil.isType(this.internalValue, TYPE_ORDER_TIMESTAMP)
